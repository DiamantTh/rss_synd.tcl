# config-convert.tcl -- Hilfsskript zur Konvertierung der rss-sync.tcl-Konfiguration
#
# Aufruf:
...
namespace eval ::config_convert {
        ...
        proc load_configuration {format inputPath} {
                ...
                set scriptPath [file join $projectRoot rss-sync.tcl]
                if {![file exists $scriptPath]} {
                        error "rss-sync.tcl nicht gefunden unter '$scriptPath'"
                }
